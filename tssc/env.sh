...
export IMAGE_URL=${IMAGE_URL-quay-quay-quay-test.apps.salamander.aimlworkbench.com/rhdh/quarkus-e2e-test:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/deanpeterson/quarkus-e2e-test-gitops
